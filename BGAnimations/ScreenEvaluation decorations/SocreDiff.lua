...
local function GetBestScoreByPn(pn)
	...
	if (song and GAMESTATE:GetPlayMode()=='PlayMode_Regular') then
		if song:HasStepsTypeAndDifficulty(st,diff) then
			...
			--assert(topscore);
			if(topscore == curScore and scores[2]) then
...
local function arrangeScoreDiff(pn,sd,simbol,sdColor)
	...
	return Def.ActorFrame {
			...
			LoadActor("TargetScore_panel.png")..{
				InitCommand=cmd(x,panelX;y,panelY;addy,-50;diffusealpha,0;zoomy,0;zoomx,0.40;);
				OnCommand=cmd(sleep,0.000;linear,0.2;zoomy,0.40;addy,50;diffusealpha,0.95);
				OffCommand=cmd(sleep,0.0000;sleep,0.016;linear,0.3;zoomy,0;addy,-50;diffusealpha,0;);
			};
			LoadActor("TargetScore_subpanel.png")..{
				InitCommand=cmd(x,panelX;y,panelY;addy,-50;diffusealpha,0;zoomy,0;zoomx,0.40;);
				OnCommand=cmd(sleep,0.000;linear,0.2;zoomy,0.40;addy,50;sleep,0.5;linear,0.2;diffusealpha,0.95);
				OffCommand=cmd(sleep,0.0000;sleep,0.016;linear,0.3;zoomy,0;addy,-50;diffusealpha,0;);
			};
			LoadActor("PlayertScore_subpanel.png")..{
				InitCommand=cmd(x,panelX;y,panelY;addy,-50;diffusealpha,0;zoomy,0;zoomx,0.40;);
				OffCommand=cmd(stoptweening;sleep,0.016;linear,0.3;zoomy,0;addy,-20;diffusealpha,0;);
				OnCommand=function(self)
					if (sd>0) then
						(cmd(sleep,0.000;linear,0.2;zoomy,0.40;addy,50;diffusealpha,0.95;sleep,2.5;linear,0.25;addy,-28))(self);
					else
						(cmd(sleep,0.000;linear,0.2;zoomy,0.40;addy,50;diffusealpha,0.95;sleep,2.5;linear,0.5;addy,0))(self);
					end
				end
			};
			LoadFont("_helveticaneuelt pro 65 md 24px")..{
				InitCommand=cmd(shadowlength,0;zoomy,0.4;zoomx,0.6;diffusealpha,0;);
				...
				OnCommand=function(self)
					...
					(cmd(diffusealpha,0;sleep,2.7;linear,0.2;diffusealpha,0.8))(self);
